...
<div class="container my-3">
    ...
    <div class="row">
        <div class="col-10">
            <h4 class="ml-4">All Categories</h4>
        </div>
        <div class="col-2">
            <a href="add-category.php" class="btn btn-info btn-sm " role="button" aria-pressed="true"><svg id="addSvg" width="1.5em" height="1.5em"
    ...
    <table class="table  table-hover  table-bordered my-4">
        ...
        ?>
            <tr>
                ...
                <td class="text-center"><?php echo $row['no_of_post']; ?></td>
                ...
                <td class="text-center"><a href="delete-category.php?id=<?php echo $row['category_id']; ?>"><svg class="svgAction" width="1em" height="1em" viewBox="0 0 16 16"
                            class="bi bi-archive-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
